...
// ANSWER: O(n) - loops through data linearly 
// Q: What is the space complexity?
// ANSWER: O(1) - fixed amt of data
...
function findFourth(numbers) {
  ...
  // ANSWER: O(n) because even though it is set to find fourth element, arrays <= 3 elements will still depend on n;
  // Q: Given an array of numbers, what is the space complexity of this function?
  // ANSWER: O(1) because count is still going to be determined by the fourth element regardless of input size.
  ...
  // ANSWER: maybe something like so:
  // function findFo(numbers) {
  //         if (numbers[3] !== undefined) {
  //           return answer = numbers[3]
  //         } else console.log('array too smol');
  //   }
  //            or

  // let findsies = (arr) => {
  //   result = arr[3] !== undefined ? arr[3] : 'not big enough tho';
  //   return result;
  // }
  // console.log(findsies(numbers));

  // this solution would have time complexity of O(1) since the comparison is not dependent on size of the input data.
  //   nummies = [1,2,3,5,4,4,4,4,4];
  //   console.log(findFo(nummies));
...
// ANSWER:O(1) because the fn only counts to 5, regardless of input data.

// Q: What is the space complexity of this function?
// ANSWER: O(1) because the fn is not storing or manipulating any input data. input size does not affect the total space required by algo.
...
// Q: What is the time complexity of this function?
// ANSWER: O(n) because the loop within this printB will increase in time req'd as input number increases, linear relationship.

// Q: What is the space complexity of this function?
// ANSWER: O(1) because the input size doesn't affect computer space req'd.
...
// 7) -------------------------------------------------------
//COMMENTED OUT HERE// let numbers = [76,35,73,13,4,88,23,12,86,1,54,9,10,2]                //here here here//
